    ...
    public Enemy(EnemyType type, float x, float y) {
        ...
        switch (type) {
            ...
            case PUMPKIN:
                ...
                enemyWalkingL = new Image[4];
                enemyWalkingL[0] = ENEMY_SPRITESHEET.getSubimage(64, 16, 16, 16);
                enemyWalkingL[1] = ENEMY_SPRITESHEET.getSubimage(64 + 16, 16, 16, 16);
                enemyWalkingL[2] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 2, 16, 16, 16);
                enemyWalkingL[3] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 3, 16, 16, 16);
                enemyWalkingR = new Image[4];
                enemyWalkingR[0] = ENEMY_SPRITESHEET.getSubimage(64, 32, 16, 16);
                enemyWalkingR[1] = ENEMY_SPRITESHEET.getSubimage(64 + 16, 32, 16, 16);
                enemyWalkingR[2] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 2, 32, 16, 16);
                enemyWalkingR[3] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 3, 32, 16, 16);
                life = 3;
                forward = true;
                archer = true;
                runFromPlayer = true;
            ...
            case ICE_STATUE:
                enemyIdle = new Image[1];
                enemyIdle[0] = ENEMY_SPRITESHEET.getSubimage(128, 32, 16, 16);
                walk = false;
                life = 8;
                damage = 10;
                vision = 1;
            ...
            case AXOLOTL:
                enemyIdle = new Image[8];
                enemyIdle[0] = ENEMY_SPRITESHEET.getSubimage(64, 96, 16, 16);
                enemyIdle[1] = enemyIdle[0];
                enemyIdle[2] = enemyIdle[0];
                enemyIdle[3] = enemyIdle[0];
                enemyIdle[4] = ENEMY_SPRITESHEET.getSubimage(64, 96, 16, 16);
                enemyIdle[5] = enemyIdle[4];
                enemyIdle[6] = enemyIdle[4];
                enemyIdle[7] = enemyIdle[4];
                enemyWalkingR = new Image[4];
                enemyWalkingR[0] = ENEMY_SPRITESHEET.getSubimage(0, 112 + 16, 16, 16);
                enemyWalkingR[1] = ENEMY_SPRITESHEET.getSubimage(16, 112 + 16, 16, 16);
                enemyWalkingR[2] = ENEMY_SPRITESHEET.getSubimage(16 * 2, 112 + 16, 16, 16);
                enemyWalkingR[3] = ENEMY_SPRITESHEET.getSubimage(16 * 3, 112 + 16, 16, 16);
                enemyWalkingL = new Image[4];
                enemyWalkingL[0] = ENEMY_SPRITESHEET.getSubimage(0, 112, 16, 16);
                enemyWalkingL[1] = ENEMY_SPRITESHEET.getSubimage(16, 112, 16, 16);
                enemyWalkingL[2] = ENEMY_SPRITESHEET.getSubimage(16 * 2, 112, 16, 16);
                enemyWalkingL[3] = ENEMY_SPRITESHEET.getSubimage(16 * 3, 112, 16, 16);
                life = 1;
                damage = 0;
                vision = 4;
                speed = 0.3f;
            ...
            case ELF:
                enemyIdle = new Image[1];
                enemyWalkingR = new Image[8];
                enemyWalkingR[0] = ENEMY_SPRITESHEET.getSubimage(64, 128, 16, 16);
                enemyWalkingR[1] = ENEMY_SPRITESHEET.getSubimage(64 + 16, 128, 16, 16);
                enemyWalkingR[2] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 2, 128, 16, 16);
                enemyWalkingR[3] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 3, 128, 16, 16);
                enemyWalkingR[4] = ENEMY_SPRITESHEET.getSubimage(64, 112, 16, 16);
                enemyWalkingR[5] = ENEMY_SPRITESHEET.getSubimage(64 + 16, 112, 16, 16);
                enemyWalkingR[6] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 2, 112, 16, 16);
                enemyWalkingR[7] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 3, 112, 16, 16);
                enemyWalkingL = new Image[8];
                enemyWalkingL[0] = ENEMY_SPRITESHEET.getSubimage(64, 112, 16, 16);
                enemyWalkingL[1] = ENEMY_SPRITESHEET.getSubimage(64 + 16, 112, 16, 16);
                enemyWalkingL[2] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 2, 112, 16, 16);
                enemyWalkingL[3] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 3, 112, 16, 16);
                enemyWalkingL[4] =ENEMY_SPRITESHEET.getSubimage(64, 144, 16, 16);
                enemyWalkingL[5] = ENEMY_SPRITESHEET.getSubimage(64 + 16, 144, 16, 16);
                enemyWalkingL[6] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 2, 144, 16, 16);
                enemyWalkingL[7] = ENEMY_SPRITESHEET.getSubimage(64 + 16 * 3, 144, 16, 16);
                life = 100;
                bouncer = true;
                damage = 50;
                hitVision = 2;
